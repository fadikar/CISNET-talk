...
```{=html}
<!-- Oval spoke diagram: rx=380 ry=200, center=(480,270), container 960×540 -->
<div style="position:relative;width:960px;height:540px;margin:0 auto;">

  <!-- SVG spokes clipped to run only between center box border and card border -->
  <!-- Center box: left=375, right=585, top=252, bottom=358 (center at 480,305) -->
  <!-- Jonathan card bottom≈165; Nicholson card left=771; David card left=633; Arindam card right=327; Mickael card right=184 -->
  ...
  <!-- Jonathan — top: member center(480,70) → card top-left(405,5) -->
  ...
  <!-- Nicholson — top-right: member center(841,208) → card top-left(766,143) -->
  ...
  <!-- David — bottom-right: member center(703,432) → card top-left(628,367) -->
  ...
  <!-- Arindam — bottom-left: member center(257,432) → card top-left(182,367) -->
  ...
  <!-- Mickael — top-left: member center(119,208) → card top-left(44,143) -->
