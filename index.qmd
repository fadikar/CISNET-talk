...
<div style="display:flex;align-items:flex-start;gap:20px;">
  ...
  <div style="flex:0 0 835px;height:470px;overflow:hidden;position:relative;">
  ...
  <div style="flex:1;">
    ...
    <div style="display:flex;flex-direction:column;gap:12px;font-size:0.86em;">
      ...
      <div style="background:#fef3c7;border-left:4px solid #d97706;border-radius:0 8px 8px 0;padding:9px 13px;">
        ...
        <div style="color:#555;font-size:0.88em;margin-top:2px;">multivariate time-series outputs, functional data</div>
      </div>
